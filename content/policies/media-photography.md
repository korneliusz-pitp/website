...
- **"Think Consent":** Just because you _can_ take a photo doesn't mean you should. Asking first is our culture.
...
1. Look for a "No Photo" badge. If present, move away.

2. Ask: "Hi, I'm from the Content Team, do you mind if I get a photo of your outfit?"

3. Take the photo.

4. Show the attendee the photo if possible.

5. If they change their mind later, they can email [events@pupsinthepark.uk](mailto:events@pupsinthepark.uk).

### 7.2. Takedown Requests

1. Attendee emails/messages requesting removal of a photo from Social Media/website.

2. Content Lead verifies the image.

3. The image is deleted from public channels immediately.

4. Image is deleted from the archive (unless required for legal reasons).

### 7.3. Storage

1. SD cards must be wiped after upload to the secure PITP Google Drive

2. Images are stored in the [Media Archive](https://drive.google.com/open?id=1JiBCjMMtoB6M_nimqkmbBjbX2ly4vGm7) folder, accessible only to the Management Team and Team Leads
...
For any questions regarding this policy, media queries, or takedown requests, please contact the Event Coordinator via [events@pupsinthepark.uk](mailto:events@pupsinthepark.uk).
